...
using special_boundary_fct = std::function<void(const unsigned, const unsigned, Field2D&, Field2D&)>;

using init_geometry_fct = std::function<std::vector<CELL>(const Config::geo&)>;
